...
- **Circulation** (vertical, `kit/deriveCirculation.ts`): stairs are **derived, not hand-placed** — `deriveCirculation(cells, {groundDoors}, circulation) → Stair[]` (deriveSkin computes the ground door faces). Two kinds of auto stair:
